...
from PyQt5.QtWidgets import QFileDialog, QHeaderView, QTableWidgetItem, QTextEdit
...
class Ui_MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        uic.loadUi(os.path.abspath(os.path.join(os.getcwd(), "src", "ramp_gui", 'ramp_gui.ui')), self)
    ...
    def ramplite_simulation(self):
        try:
            ...
            self.profiles_lite = pd.DataFrame(
                index=pd.date_range(start=date_from_widget, periods=1440 * n_days, freq="T"))
    ...
    def generate_plots_lite(self):
        ...
        if self.Minute_radioButton_1.isChecked():
            ...
            minute_profile_lite.plot(ax=self.ax, kind="line", title=self.title, xlabel="Time (Minutes)",
                                     ylabel="Power(W)")
            ...
            fifteen_minute_profile_lite.plot(ax=self.ax, kind="line", title=self.title, xlabel="Time (15 Minutes)",
                                             ylabel="Power(W)")
            ...
            hourly_profile_lite.plot(ax=self.ax, kind="line", title=self.title, xlabel="Time (Hours)",
                                     ylabel="Power(W)")
            ...
            monthly_profile_lite.plot(ax=self.ax, kind="line", title=self.title, xlabel="Time (Months)",
                                      ylabel="Power(W)")
            ...
            monthly_bar_profile_lite.index = monthly_bar_profile_lite.index.strftime(
                '%B')  # Format the index to month names
    ...
    def save_figure_lite(self):
        ...
        file_name, _ = QFileDialog.getSaveFileName(self.tabWidget, "Save Figure", "",
    ...
    def save_as_csv_lite(self):
        filename, _ = QtWidgets.QFileDialog.getSaveFileName(None, "Save as .csv", "",
    ...
    def save_created_file(self):
        try:
            ...
            if num_rows > 0 and num_cols > 0:
                ...
                writer._save()
                print(
                    f"File named 'User and Appliance Database' is saved to {file_path}, File will be replaced when next time you save it, You may copy and save it somewhere else for future purpose or else")
            else:
    ...
    def ramp_advance_simulation(self):
        ...
        try:
            ...
            if self.selected_users_radioButton_1.isChecked() and hasattr(self,
                                                                         'selected_users') and self.selected_users:
            ...
            # Define dataframe
            self.profiles_advance = pd.DataFrame(
                index=pd.date_range(start=selected_date.toString("yyyy-MM-dd"), periods=1440 * n_days, freq="T"))
            ...
            self.profiles_advance.plot(ax=self.ax1, kind="line", title=self.title1, xlabel="Time(Minutes)",
                                       ylabel="Power(W)")
            ...
            sum_of_all_users.plot(ax=self.ax2, kind='line', title=self.title2, xlabel="Time(Minutes)",
                                  ylabel="Power(W)")
    ...
    def generate_plots_ramp_advance(self):
        ...
        if self.Minute_radioButton_2.isChecked():
            ...
            minute_profile_advance.plot(ax=self.ax1, kind="line", title=self.title1, xlabel="Time (Minutes)",
                                        ylabel="Power(W)")
            ...
            minute_profile_advance_sum.plot(ax=self.ax2, kind="line", title=self.title2, xlabel="Time (MInutes)",
                                            ylabel="Power(W)")
            ...
            fifteen_minute_profile_advance.plot(ax=self.ax1, kind="line", title=self.title1, xlabel="Time (15 Minutes)",
                                                ylabel="Power(W)")
            ...
            fifteen_minute_profile_advance_sum.plot(ax=self.ax2, kind="line", title=self.title2,
                                                    xlabel="Time (15 Minutes)", ylabel="Power(W)")
            ...
            hourly_profile_advance.plot(ax=self.ax1, kind="line", title=self.title1, xlabel="Time (Hours)",
                                        ylabel="Power(W)")
            ...
            hourly_profile_advance_sum.plot(ax=self.ax2, kind="line", title=self.title2, xlabel="Time (Hours)",
                                            ylabel="Power(W)")
            ...
            daily_profile_advance.plot(ax=self.ax1, kind="line", title=self.title1, xlabel="Time (Days)",
                                       ylabel="Power(W)")
            ...
            daily_profile_advance_sum.plot(ax=self.ax2, kind="line", title=self.title2, xlabel="Time (Days)",
                                           ylabel="Power(W)")
            ...
            monthly_profile_advance.plot(ax=self.ax1, kind="line", title=self.title1, xlabel="Time (Months)",
                                         ylabel="Power(W)")
            ...
            monthly_profile_advance_sum.plot(ax=self.ax2, kind="line", title=self.title2, xlabel="Time (Months)",
                                             ylabel="Power(W)")
            ...
            monthly_bar_profile_advance.index = monthly_bar_profile_advance.index.strftime(
                '%B')  # Format the index to month names
            monthly_bar_profile_advance.plot(ax=self.ax1, kind="bar", title=self.title1, xlabel="Month",
                                             ylabel="Power(W)")
            self.ax1.set_xlabel("Time (Months)", fontsize=12)  # Set font size for x-label
            self.ax1.set_ylabel("Power(W)", fontsize=12)  # Set font size for x-label and y-label
            self.figure2.tight_layout()
            ...
            monthly_bar_profile_advance_sum.index = monthly_bar_profile_advance_sum.index.strftime(
                '%B')  # Format the index to month names
            monthly_bar_profile_advance_sum.plot(ax=self.ax2, kind="bar", title=self.title2, xlabel="Month",
                                                 ylabel="Power(W)")
            self.ax2.set_xlabel("Time (Months)", fontsize=12)  # Set font size for x-label
            self.ax2.set_ylabel("Power(W)", fontsize=12)  # Set font size for x-label and y-label
            self.figure3.tight_layout()
    ...
    def save_image_1(self):
        if self.figure2.axes:
            filename, _ = QtWidgets.QFileDialog.getSaveFileName(None, "Save Ax1 Image", "",
    ...
    def save_image_2(self):
        if self.figure3.axes:
            filename, _ = QtWidgets.QFileDialog.getSaveFileName(None, "Save Ax2 Image", "",
                                                                "Images (*.png *.xpm *.jpg *.bmp);;All Files (*)")
            if filename:
    ...
    def treeview(self, file_path):
        try:
            ...
            self.model.setHorizontalHeaderLabels(
                ['User Name> Appliance> Name / Number', 'power', 'num_windows', 'func_time', 'wd_we_type'])
